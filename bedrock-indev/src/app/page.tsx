...
const HomePage: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-gray-800">
      <header className="fixed h-48 top-0  flex items-center justify-between w-full p-5 bg-gray-700 text-white z-50">
        <h1 className="text-6xl font-semibold ml-20 flex items-center"><img src='pictures/bedrock.png' alt='-' className="mr-3" />Bedrock</h1>
      ...
      <main className="flex flex-col items-center justify-center w-full px-5 py-10 mt-24 pb-96">
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-2">Key Solution Requirements</h2>
      ...
      <h1 className="text-3xl font-semibold ml-20 flex items-center"><img src='pictures/bedrock.png' alt='-' className="mr-3" />Bedrock</h1>
        <div className="flex justify-end w-60% space-x-20 mr-40">
